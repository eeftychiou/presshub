...
class PressHub_AI_Provider_Defaults {
    ...
    const PROVIDER_TEMPLATES = [
        ...
        'gemini' => [
            'type'             => 'gemini',
            'name'             => 'Google Gemini (Text & Speech)',
            'base_url'         => 'https://generativelanguage.googleapis.com/v1beta',
            'default_model'    => 'gemini-2.0-flash',
            'available_models' => [ 'gemini-3.1-flash-tts-preview', 'gemini-2.5-flash-preview-tts', 'gemini-2.0-flash', 'gemini-1.5-pro-latest', 'gemini-1.5-flash-latest' ],
            'timeout'          => 300,
            'temperature'      => 0.7,
            'max_tokens'       => 10000,
            'headers'          => [],
