    ...
    public function save_settings(): void {
        try {
            ...
            $options_map = [
                ...
                'presshub_ai_briefing_podcast_prompt_1'   => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_2'   => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_3'   => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_style'      => [ 'PressHub_AI_Settings_Storage', 'sanitize_podcast_style' ],
                'presshub_ai_briefing_podcast_prompt_1_default_greek_chat'            => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_2_default_greek_chat'            => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_3_default_greek_chat'            => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_1_bbc_broadcasting_standards'    => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_2_bbc_broadcasting_standards'    => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_3_bbc_broadcasting_standards'    => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_1_conversational_news_reporting' => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_2_conversational_news_reporting' => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
                'presshub_ai_briefing_podcast_prompt_3_conversational_news_reporting' => [ 'PressHub_AI_Settings_Storage', 'sanitize_briefing_prompt' ],
