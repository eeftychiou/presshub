...
class PressHub_AI_Podcast_Producer {
    ...
    private static function get_default_greek_chat_prompt( int $host_count ): string {
        if ( 1 === $host_count ) {
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητή (Speaker Tags):\n"
                ...
                . "   - Απαγόρευση Ονομάτων: Ο παρουσιαστής ΔΕΝ πρέπει ΠΟΤΕ να αναφέρεται στον εαυτό του με όνομα (μην επινοείς και μην χρησιμοποιείς κανένα όνομα, και μην εκφωνείς ποτέ τεχνικές ετικέτες όπως «Speaker 1» ή «παρουσιαστής»). Η εκφώνηση γίνεται άμεσα και φυσικά χωρίς προσωπική ονομαστική αναφορά.\n";
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                ...
                . "   - Απαγόρευση Ονομάτων: Οι τρεις ομιλητές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή ο ένας στον άλλον με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως «Speaker 1», «Speaker 2», κ.λπ.). Ο διάλογος διεξάγεται άμεσα, φυσικά και χωρίς ονομαστικές προσφωνήσεις.\n";
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                ...
                . "   - Απαγόρευση Ονομάτων: Οι δύο παρουσιαστές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή ο ένας στον άλλον με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως «Speaker 1» ή «Speaker 2»). Ο διάλογος διεξάγεται άμεσα, φυσικά και χωρίς ονομαστικές προσφωνήσεις.\n";
            $flow_rule = "3. Ροή & Ύφος Διαλόγου (Εξαιρετικά Φυσικό & Διαδραστικό - NotebookLM Audio Overview Style):\n"
        ...
        $date_rule = "\n6. Μορφοποίηση Ημερομηνιών για TTS (Φυσική Προφορική Εκφώνηση):\n"
            . "   - Όλες οι ημερομηνίες (π.χ. 03/05/2026, 2026-05-03, ή ημερομηνίες μέσα στα κείμενα των ειδήσεων) ΠΡΕΠΕΙ υποχρεωτικά να μετατρέπονται και να γράφονται ολογράφως ως φυσικός προφορικός λόγος (π.χ. «3 Μαΐου 2026» ή αντίστοιχα «3rd of May 2026»).\n"
            . "   - Μη γράφετε ποτέ αριθμητικές μορφές με κάθετο ή παύλα (όπως 03/05/2026), ώστε να διασφαλίζεται η άριστη και απρόσκοπτη εκφώνηση από τη μηχανή Text-to-Speech (TTS).\n";
    ...
    private static function get_bbc_broadcasting_standards_prompt( int $host_count ): string {
        if ( 1 === $host_count ) {
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητή (Speaker Tags):\n"
                . "   - Κάθε ατάκα/παράγραφος ΠΡΕΠΕΙ να ξεκινάει σε νέα γραμμή με την ακριβή ετικέτα του παρουσιαστή: [SPEAKER_1]:\n"
                . "   - Μη χρησιμοποιείς άλλες ετικέτες ή αφήγηση εκτός του [SPEAKER_1]:.\n"
                . "   - Απαγόρευση Ονομάτων: Ο παρουσιαστής ΔΕΝ πρέπει ΠΟΤΕ να αναφέρεται στον εαυτό του με όνομα (μην επινοείτε και μην χρησιμοποιείτε κανένα όνομα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1] ή «παρουσιαστής»). Η εκφώνηση παραμένει επίσημη, απρόσωπη και επαγγελματική.\n";
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                ...
                . "   - Απαγόρευση Ονομάτων: Οι παρουσιαστές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή στους συναδέλφους τους με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1], [SPEAKER_2], [SPEAKER_3]). Ο διάλογος διεξάγεται άμεσα, επαγγελματικά και χωρίς ονομαστικές προσφωνήσεις.\n";
            $flow_rule = "3. Ροή & Ύφος Εκφώνησης (Πρότυπα BBC - BBC Broadcasting Standards):\n"
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                ...
                . "   - Απαγόρευση Ονομάτων: Οι παρουσιαστές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή ο ένας στον άλλον με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1] ή [SPEAKER_2]). Ο διάλογος διεξάγεται άμεσα, επαγγελματικά και χωρίς ονομαστικές προσφωνήσεις.\n";
            $flow_rule = "3. Ροή & Ύφος Εκφώνησης (Πρότυπα BBC - BBC Broadcasting Standards):\n"
                . "   - Ύφος: επίσημος, συγκρατημένος, ουδέτερος, τριτοπρόσωπος λόγος. Απευθύνσου στο κοινό σε τρίτο πρόσωπο ή με το απρόσωπο «εμείς» όπου επιτρέπεται δημοσιογραφικά· μην χρησιμοποιείς ποτέ πρώτο ενικό πρόσωπο.\n"
                . "   - Χωρίς λέξεις γεμίσματος, χωρίς ανέμελα πειράγματα ή χαλαρές παρεκβάσεις. Ο διάλογος είναι δομημένος και πειθαρχημένος.\n"
    ...
    private static function get_conversational_news_reporting_prompt( int $host_count ): string {
        if ( 1 === $host_count ) {
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητή (Speaker Tags):\n"
                . "   - Κάθε ατάκα/παράγραφος ΠΡΕΠΕΙ να ξεκινάει σε νέα γραμμή με την ακριβή ετικέτα του παρουσιαστή: [SPEAKER_1]:\n"
                . "   - Μη χρησιμοποιείς άλλες ετικέτες ή αφήγηση εκτός του [SPEAKER_1]:.\n"
                . "   - Απαγόρευση Ονομάτων: Ο παρουσιαστής ΔΕΝ πρέπει ΠΟΤΕ να αναφέρεται στον εαυτό του με όνομα (μην επινοείτε και μην χρησιμοποιείτε κανένα όνομα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1] ή «παρουσιαστής»). Το ύφος είναι άμεσο και οικείο χωρίς αναφορά σε προσωπικό όνομα.\n";
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                . "   - Κάθε ατάκα ΠΡΕΠΕΙ να ξεκινάει σε νέα γραμμή με την ακριβή ετικέτα του ομιλητή: [SPEAKER_1]:, [SPEAKER_2]: ή [SPEAKER_3]:\n"
                . "   - Μη χρησιμοποιείς άλλες ετικέτες ή αφήγηση εκτός των τριών ετικετών ομιλητών.\n"
                . "   - Απαγόρευση Ονομάτων: Οι τρεις παρουσιαστές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή στους άλλους με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1], [SPEAKER_2], [SPEAKER_3]). Η συνομιλία γίνεται άμεσα και φυσικά χωρίς ονομαστικές προσφωνήσεις.\n";
            ...
            $speaker_rule = "2. Αυστηρή Μορφή Ομιλητών (Speaker Tags):\n"
                . "   - Κάθε ατάκα ΠΡΕΠΕΙ να ξεκινάει σε νέα γραμμή με την ακριβή ετικέτα του ομιλητή: [SPEAKER_1]: ή [SPEAKER_2]:\n"
                . "   - Μη χρησιμοποιείς άλλες ετικέτες ή αφήγηση εκτός των δύο ετικετών ομιλητών.\n"
                . "   - Απαγόρευση Ονομάτων: Οι δύο παρουσιαστές ΔΕΝ πρέπει ΠΟΤΕ να αναφέρονται στον εαυτό τους ή ο ένας στον άλλον με ονόματα (μην επινοείτε και μην χρησιμοποιείτε ποτέ ονόματα, και μην εκφωνείτε ποτέ τεχνικές ετικέτες όπως [SPEAKER_1] ή [SPEAKER_2]). Η συνομιλία γίνεται άμεσα και φυσικά χωρίς ονομαστικές προσφωνήσεις.\n";
            $flow_rule = "3. Ροή & Ύφος Διαλόγου (Ζωντανό & Συνομιλητικό με Άποψη - improved by the hosts):\n"
    ...
    public function build_dialogue_prompt( array $articles, string $preset_id = '', string $duration = '', string $date = '', string $context_mode = 'curated_briefing', array $selected_article_ids = [], ?string $briefing_text = null ): array {
        ...
        if ( 1 === $host_count ) {
            $presenter_mention = sprintf( __( 'The script should be delivered by the single presenter labelled [SPEAKER_1]. The presenter must never refer to themselves by name. Any dates (e.g. 03/05/2026) must be converted and written out in natural spoken words (e.g. 3 Μαΐου 2026 / 3rd of May 2026) for optimal TTS performance.', 'presshub-ai-editor' ) );
        } elseif ( 3 === $host_count ) {
            $presenter_mention = sprintf( __( 'The script should be delivered by the three presenters labelled [SPEAKER_1], [SPEAKER_2] and [SPEAKER_3]. The presenters must never refer to each other or themselves by name. Any dates (e.g. 03/05/2026) must be converted and written out in natural spoken words (e.g. 3 Μαΐου 2026 / 3rd of May 2026) for optimal TTS performance.', 'presshub-ai-editor' ) );
        } else {
            $presenter_mention = sprintf( __( 'The script should be delivered by the two presenters labelled [SPEAKER_1] and [SPEAKER_2]. The presenters must never refer to each other or themselves by name. Any dates (e.g. 03/05/2026) must be converted and written out in natural spoken words (e.g. 3 Μαΐου 2026 / 3rd of May 2026) for optimal TTS performance.', 'presshub-ai-editor' ) );
        }
